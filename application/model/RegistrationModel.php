...
class RegistrationModel
{
    ...
    public static function writeNewUserToDatabase($user_name, $user_password_hash, $user_email, $user_creation_timestamp, $user_activation_hash)
    {
        ...
        $sql = "INSERT INTO users (user_name, user_password_hash, user_email, user_full_name, user_creation_timestamp, user_activation_hash, user_provider_type)
                    VALUES (:user_name, :user_password_hash, :user_email, :user_full_name, :user_creation_timestamp, :user_activation_hash, :user_provider_type)";
