...
return array(
    ...
    'EMAIL_PASSWORD_RESET_FROM_EMAIL' => 'no-reply@umsframework.com',
    ...
    'EMAIL_VERIFICATION_FROM_EMAIL' => 'no-reply@umsframework.com',
	...
	/**
	 * Current version of the software - This can be useful for deployment versions (If developing multiple parallel versions of a platform)
	 */
	'VERSION' => '1.0.0', // deprecated (now used in site settings)
);
