...
class View
{
    ...
    public function render($filename, $data = null)
    {
        ...
        require Config::get('PATH_VIEW') . Config::get('THEME') . '/_templates/header.php';
        require Config::get('PATH_VIEW') . Config::get('THEME') . '/' . $filename . '.php';
        require Config::get('PATH_VIEW') . Config::get('THEME') . '/_templates/footer.php';
    }
    ...
    public function renderFeedbackMessages()
    {
        ...
        require Config::get('PATH_VIEW') . Config::get('THEME') . '/' . '_templates/feedback.php';
